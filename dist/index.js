...
const file_command_1 = __nccwpck_require__(10);
const utils_1 = __nccwpck_require__(820);
const os = __importStar(__nccwpck_require__(87));
...
const http_client_1 = __nccwpck_require__(647);
const auth_1 = __nccwpck_require__(851);
const core_1 = __nccwpck_require__(61);
class OidcClient {
...
const pm = __nccwpck_require__(299);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(543);
            }
            const agentOptions = {
...
var whatwgUrl = _interopDefault(__nccwpck_require__(46));
...
let convert;
try {
	convert = __nccwpck_require__(733).convert;
} catch (e) {}
...
const usm = __nccwpck_require__(513);
...
const conversions = __nccwpck_require__(109);
const utils = __nccwpck_require__(638);
...
exports.URL = __nccwpck_require__(63).interface;
exports.serializeURL = __nccwpck_require__(513).serializeURL;
exports.serializeURLOrigin = __nccwpck_require__(513).serializeURLOrigin;
exports.basicURLParse = __nccwpck_require__(513).basicURLParse;
exports.setTheUsername = __nccwpck_require__(513).setTheUsername;
exports.setThePassword = __nccwpck_require__(513).setThePassword;
exports.serializeHost = __nccwpck_require__(513).serializeHost;
exports.serializeInteger = __nccwpck_require__(513).serializeInteger;
exports.parseURL = __nccwpck_require__(513).parseURL;
...
const tr46 = __nccwpck_require__(376);
